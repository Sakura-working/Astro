...
export const siteConfig: SiteConfig = {
	title: "Sameko",
	subtitle: "Maybe Just Keep Alive",
	siteURL: "https://github.com/Sakura-working/Astro/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-02-21", // 站点开始运行日期，用于站点统计组件计算运行天数

	timeZone: 8, // 中国大陆时区 UTC+8
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		...
		home: "点击这里回到首页！", // 首页提示
		skin: ["想看我新衣服吗？", "新衣服很好看哦~"], // 换装提示
		close: "下次再见~", // 关闭提示
		link: "https://github.com/Sakura-working/Astro", // 关于链接
	},
};
